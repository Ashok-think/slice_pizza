...
export const pizzas: Pizza[] = [
  ...
  },
  {
    ...
    storySection: { title: "Bangalore's Own Fusion", description: "The Paneer Tikka Masala was born in our Bangalore kitchen as a tribute to the city's love of both great pizza and great Indian food. We marinate the paneer in a yogurt-spice blend for 24 hours before chargrilling, then drizzle fresh mint chutney over the finished pizza." },
